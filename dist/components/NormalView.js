export const renderNormalView = ({ node, projected, isHovered, isSelected, time, glitchX, glitchY, ctx, clusterColor, }) => {
    ...
    gradient.addColorStop(0, isSelected ? "#ff00ff" : isHovered ? "#00ffff" : nodeColor);
    gradient.addColorStop(0.5, isSelected ? "#ff0088" : isHovered ? "#0088ff" : nodeColor + "88");
