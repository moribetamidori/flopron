...
(() => {
  ...
  var require_react_dom_client_production = __commonJS({
    "node_modules/.pnpm/react-dom@19.1.1_react@19.1.1/node_modules/react-dom/cjs/react-dom-client.production.js"(exports) {
      ...
      var isomorphicReactPackageVersion$jscomp$inline_1785 = React13.version;
  ...
  var useAudioContext = () => {
    ...
    const playNodeSound = async (node) => {
  ...
  var use3DRendering = () => {
    ...
    const [rotationY, setRotationY] = (0, import_react4.useState)(0);
    ...
    const project3D = (x, y, z, sidebarCollapsed) => {
      const distance = 1e3;
  ...
  var useCanvasInteraction = ({
    ...
    const [lastMousePos, setLastMousePos] = (0, import_react5.useState)({ x: 0, y: 0 });
    const [lastTouchDistance, setLastTouchDistance] = (0, import_react5.useState)(
      null
    );
    ...
    const handleMouseMove = (e) => {
      ...
      const hovered = projectedNodes.find((node) => {
        if (previewMode && node.dataLog) {
          ...
          return x >= node.projectedX - halfSize && x <= node.projectedX + halfSize && y >= node.projectedY - halfSize && y <= node.projectedY + halfSize;
        } else {
  ...
  var renderPreviewView = ({
    ...
    const halfSize = size / 2;
    ctx.fillStyle = isSelected ? "rgba(0, 255, 255, 0.3)" : isHovered ? "rgba(0, 255, 255, 0.2)" : "rgba(0, 0, 0, 0.8)";
    ctx.fillRect(
  ...
  var CanvasRenderer = ({
    ...
    (0, import_react6.useEffect)(() => {
      ...
      connections.forEach((connection) => {
        ...
        const getConnectionColor = (tagCount) => {
          if (tagCount === 0) return "#00ffff";
          const colors = [
            "#00ffff",
            // Cyan - 1 shared tag
            "#ffff00",
            // Yellow - 2 shared tags
            "#ff00ff",
            // Magenta - 3 shared tags
            "#ff8800",
            // Orange - 4 shared tags
            "#8800ff",
            // Purple - 5 shared tags
            "#00ff88",
            // Green - 6 shared tags
            "#ff0088",
            // Pink - 7 shared tags
        ...
        if (sharedTagCount > 0) {
          ...
          ctx.globalAlpha = 0.8;
          const dotRadius = 5;
          const maxDots = Math.min(sharedTagCount, 8);
          ...
          const spacing = lineLength / (maxDots + 1);
            ...
            if (onDotHover) {
              ...
              if (mouseX > 0 && mouseY > 0) {
                ...
                if (distanceToMouse <= hoverRadius) {
                  ...
                  if (!window.dotHoverThrottle) {
                    window.dotHoverThrottle = requestAnimationFrame(
                      () => {
                        onDotHover(connection.sharedTags || [], dotX, dotY);
                        window.dotHoverThrottle = null;
                      }
                    );
                  }
                }
  ...
  function NodePreview({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      ...
      {
        onClick,
        className: `w-16 h-16 border-2 cursor-pointer transition-all duration-200 hover:scale-105 ${isSelected ? "border-cyan-400 bg-cyan-400/20 shadow-lg shadow-cyan-400/50" : "border-cyan-400/50 bg-black/50 hover:border-cyan-400/80 hover:bg-cyan-400/10"}`,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "div",
      {
        ...
        children: [
          ...
          !sidebarCollapsed && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "flex-1 overflow-y-auto", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "h-full", children: previewMode ? (
            // Grid view for preview mode
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "p-4", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "grid grid-cols-4 gap-3", children: nodesByNewest.map((node) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "flex justify-center", children: node.dataLog && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              NodePreview,
              {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "p-4 space-y-2", children: [
              ...
              nodesByNewest.map((node) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
                ...
                {
                  onClick: () => onNodeClick(node),
                  className: `p-3 rounded border cursor-pointer transition-all ${selectedNode?.id === node.id ? "bg-cyan-400/20 border-cyan-400 text-white" : "bg-black/50 border-cyan-400/30 text-cyan-400 hover:bg-cyan-400/10"}`,
                  children: [
  ...
  var AddNodeModal = ({
    ...
    const loadClusters = async () => {
      try {
        ...
        console.error("Failed to load clusters:", error2);
      }
    };
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const input = {
          ...
          cluster_id: formData.clusterId || void 0
        };
        ...
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "mb-4", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "grid grid-cols-5 gap-2", children: predefinedColors.map((color) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            "button",
            {
              ...
              className: `w-8 h-8 rounded border-2 transition-all hover:scale-110 ${selectedColor === color ? "border-cyan-400 scale-110" : "border-cyan-400/30 hover:border-cyan-400/60"}`,
  ...
  var CreateClusterModal = ({
    ...
    const generateUniqueColor = () => {
      ...
      const availableColors = predefinedColors2.filter(
  ...
  var AllClustersGrid = ({
      ...
      try {
        ...
        for (const cluster of clusters) {
          ...
          const clusterConnections = connections.filter(
            (conn) => clusterNodeIds.includes(conn.from_node_id) && clusterNodeIds.includes(conn.to_node_id)
          ...
          for (let i = 0; i < clusterNodes.length; i++) {
            for (let j = i + 1; j < clusterNodes.length; j++) {
              ...
              if (nodeA.dataLog?.tags && nodeB.dataLog?.tags) {
                const sharedTags = nodeA.dataLog.tags.filter(
                  (tag) => nodeB.dataLog.tags.includes(tag)
                );
                if (sharedTags.length > 0) {
                  const existingConnection = clusterConnections.find(
                    (conn) => conn.from === nodeA.id && conn.to === nodeB.id || conn.from === nodeB.id && conn.to === nodeA.id
                  );
    ...
    const getClusterColor = (clusterId) => {
      ...
      const index = clusterId.split("").reduce((acc, char) => acc + char.charCodeAt(0), 0) % colors.length;
      return colors[index];
    };
    const rotateX = (x, y, z, angle) => {
      const cos = Math.cos(angle);
          ...
          /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex bg-black/50 border border-cyan-400/50 rounded", children: [
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
              "button",
              {
                ...
                className: `px-3 py-1 text-sm transition-all duration-200 ${viewMode === "default" ? "bg-cyan-400/20 text-cyan-300" : "text-cyan-400 hover:bg-cyan-400/10"}`,
                children: "Default"
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
              "button",
              {
                ...
                className: `px-3 py-1 text-sm transition-all duration-200 ${viewMode === "preview" ? "bg-cyan-400/20 text-cyan-300" : "text-cyan-400 hover:bg-cyan-400/10"}`,
                children: "Preview"
              }
            )
          ] })
  ...
  function PKMApp() {
    ...
    const [sidebarCollapsed, setSidebarCollapsed] = (0, import_react16.useState)(false);
    const [previewMode, setPreviewMode] = (0, import_react16.useState)(false);
    const [selectedTags, setSelectedTags] = (0, import_react16.useState)([]);
    const [showAddModal, setShowAddModal] = (0, import_react16.useState)(false);
    const [clusters, setClusters] = (0, import_react16.useState)([]);
    const [selectedClusterId, setSelectedClusterId] = (0, import_react16.useState)(
      null
    );
    const [showClusterSettings, setShowClusterSettings] = (0, import_react16.useState)(false);
    const [showCreateCluster, setShowCreateCluster] = (0, import_react16.useState)(false);
    const [showAllClustersGrid, setShowAllClustersGrid] = (0, import_react16.useState)(false);
    const [filteredNodes, setFilteredNodes] = (0, import_react16.useState)([]);
    const [filteredConnections, setFilteredConnections] = (0, import_react16.useState)(
      []
    );
    const [editingCluster, setEditingCluster] = (0, import_react16.useState)(null);
    const [dotTooltip, setDotTooltip] = (0, import_react16.useState)(null);
    const databaseService = DatabaseService.getInstance();
    ...
    (0, import_react16.useEffect)(() => {
      ...
      if (selectedTags.length > 0) {
        filteredNodes2 = filteredNodes2.filter(
          (node) => node.dataLog?.tags?.some((tag) => selectedTags.includes(tag))
        );
      }
      setFilteredNodes(filteredNodes2);
      const filteredNodeIds = filteredNodes2.map((node) => node.id);
      const filteredExistingConnections = connections.filter(
        (connection) => filteredNodeIds.includes(connection.from) && filteredNodeIds.includes(connection.to)
      );
      const generatedConnections = generateSharedTagConnections(filteredNodes2);
    ...
    const currentTooltipRef = (0, import_react16.useRef)(null);
    const handleDotHover = (sharedTags, x, y) => {
      const newTooltip = { tags: sharedTags, x, y };
      const current = currentTooltipRef.current;
      if (!current || current.x !== x || current.y !== y || JSON.stringify(current.tags) !== JSON.stringify(sharedTags)) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
      "div",
      {
        ...
        style: { touchAction: "none" },
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "absolute inset-0", children: [
          ...
          dotTooltip && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            "div",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "space-y-1", children: dotTooltip.tags.map((tag, index) => /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "text-cyan-300", children: [
                "\u2022 ",
                tag
              ] }, index)) })
            }
  ...
  // src/renderer.ts
  var LoadingNeuron = () => {
    const [pulse, setPulse] = import_react17.default.useState(0);
      ...
      import_react17.default.createElement(
        ...
        import_react17.default.createElement("div", {
          style: {
            ...
            borderRadius: "50%",
            background: `radial-gradient(circle, rgba(0, 255, 255, ${0.3 + pulse * 0.2}) 0%, rgba(0, 255, 136, ${0.2 + pulse * 0.1}) 50%, transparent 70%)`,
  ...
  document.addEventListener("DOMContentLoaded", async () => {
    ...
    if (rootElement) {
      try {
        ...
        root.render(import_react17.default.createElement(LoadingNeuron));
        setTimeout(() => {
          console.log("Loading PKM app...");
          try {
            root.render(import_react17.default.createElement(PKMApp));
          } catch (error) {
        ...
        rootElement.innerHTML = '<div style="color: white; padding: 20px;">Error loading PKM app: ' + (error instanceof Error ? error.message : String(error)) + "</div>";
      }
    } else {
